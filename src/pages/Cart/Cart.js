...
const Cart = () => {
  ...
  const createOrder = (event) => {
    ...
    if (
      formValue.email !== formValue.email2 ||
      formValue.email === "" ||
      formValue.name === "" ||
      formValue.phone === ""
    ) {
  ...
  return (
    <div className="CartContainer">
      ...
      {nuevoCliente && (
        <div
          style={{ width: "70%", backgroundColor: "white", padding: "20px" }}
        >
          <h1>
            Thank you for purchasing our products, an email will soon be
            arriving in your mailbox, where you can see the status of your
            purchase.
          </h1>
          <Alert variant={"success"}>
            Your purchase has been stored correctly, your ID for the purchase
            is: {idCompra} !
          </Alert>
        </div>
      )}
